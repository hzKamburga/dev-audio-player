(()=>{var m=Object.defineProperty;var c=Object.getOwnPropertySymbols;var f=Object.prototype.hasOwnProperty,v=Object.prototype.propertyIsEnumerable;var p=(i,t,e)=>t in i?m(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e,y=(i,t)=>{for(var e in t||(t={}))f.call(t,e)&&p(i,e,t[e]);if(c)for(var e of c(t))v.call(t,e)&&p(i,e,t[e]);return i};var r=class{constructor(t,e,a){this.audio=t,this.canvas=e,this.ctx=this.canvas.getContext("2d"),this.theme=a,this.isPlaying=!1,this.animationId=null,this.audioContext=null,this.analyser=null,this.source=null,this.init()}init(){let t=()=>{if(!this.audioContext){let e=window.AudioContext||window.webkitAudioContext;this.audioContext=new e,this.analyser=this.audioContext.createAnalyser();try{this.source=this.audioContext.createMediaElementSource(this.audio),this.source.connect(this.analyser),this.analyser.connect(this.audioContext.destination)}catch(a){console.warn("Visualizer disabled: CORS restriction or audio source error.",a),this.source=null}this.analyser.fftSize=256,this.bufferLength=this.analyser.frequencyBinCount,this.dataArray=new Uint8Array(this.bufferLength)}this.audioContext.state==="suspended"&&this.audioContext.resume(),this.audio.removeEventListener("play",t)};this.audio.addEventListener("play",t)}start(){this.isPlaying=!0,this.draw()}stop(){this.isPlaying=!1,this.animationId&&cancelAnimationFrame(this.animationId)}draw(){if(!this.isPlaying||(this.animationId=requestAnimationFrame(()=>this.draw()),!this.analyser))return;this.analyser.getByteFrequencyData(this.dataArray);let t=this.canvas.width,e=this.canvas.height,a=t/this.bufferLength*2.5,o,l=0;this.ctx.clearRect(0,0,t,e);for(let s=0;s<this.bufferLength;s++){o=this.dataArray[s]/2;let d=o+25*(s/this.bufferLength),h=250*(s/this.bufferLength),u=50;this.theme==="dark"?this.ctx.fillStyle=`rgb(${d},${h},${u})`:this.ctx.fillStyle=`rgb(${d},${h},${u})`,this.ctx.fillRect(l,e-o,a,o),l+=a+1}}};var g=`.dev-audio-player {\r
